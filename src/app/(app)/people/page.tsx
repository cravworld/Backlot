    ...
    <main className="min-h-screen flex-1 bg-paper px-6 py-10 text-ink">
      <div className="mx-auto max-w-3xl">
        ...
        <section className="mb-10">
          ...
          {people.length === 0 ? (
            <p className="text-base text-ink-soft">No one in the registry yet — add someone below.</p>
          ) : (
                ...
                {people.map((p) => (
                  <tr key={p.id} className="border-b border-line hover:bg-slate">
                    <td className="py-3 pr-4">
                      ...
                      {p.preferredName && (
                        <div className="text-sm text-ink-soft">{p.preferredName}</div>
                      )}
                    </td>
                    ...
                    <td className="py-3 pr-4 font-mono text-ink-soft">{p._count.filmRoles}</td>
