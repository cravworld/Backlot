      ...
      <div className="mx-auto max-w-3xl">
        ...
        <section className="mb-10">
          ...
          {assignments.length === 0 ? (
            <p className="text-base text-ink-soft">No one assigned to this film yet.</p>
          ) : (
                ...
                {assignments.map((a) => (
                  <tr key={a.id} className="border-b border-line hover:bg-slate">
                    <td className="py-3 pr-4">
                      ...
                      <div className="text-sm text-ink-soft">{a.user.email}</div>
                    </td>
                    <td className="py-3 pr-4">{a.role.label}</td>
                    <td className="py-3 pr-4 text-ink-soft">{a.department ?? "—"}</td>
                    <td className="py-3 pr-4">
                      <span
