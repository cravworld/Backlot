    ...
    return (
      <main className="min-h-screen bg-paper px-6 py-10 text-ink">
        <div className="mx-auto max-w-3xl">
          ...
          <p className="text-sm text-ink-soft">The model gateway is an org-admin area.</p>
        </div>
      </main>
    );
  }
    ...
    <main className="min-h-screen bg-paper px-6 py-10 text-ink">
      <div className="mx-auto max-w-4xl">
        ...
        <section className="mb-10">
          ...
          {providers.length === 0 ? (
            <p className="text-sm text-ink-soft">None seeded.</p>
          ) : (
              ...
              <tbody>
                {providers.map((p) => (
                  <tr key={p.id} className="border-b border-line">
                    ...
                    <td className="py-2 font-mono text-xs text-ink-soft">{p.enabled ? "Yes" : "No"}</td>
                  </tr>
                ))}
              </tbody>
            </table>
        ...
        <section>
          ...
          {logs.length === 0 ? (
            <p className="text-sm text-ink-soft">No requests logged yet.</p>
          ) : (
                ...
                {logs.map((l) => (
                  <tr key={l.id} className="border-b border-line align-top hover:bg-slate">
                    ...
                    <td className="py-2.5 pr-4">
                      ...
                      <div className="text-xs text-ink-soft">{l.purpose}</div>
                    </td>
                    ...
                    <td className="py-2.5 max-w-xs">
                      {l.status === "ok" ? (
                        ...
                        <span className="text-xs text-clay">{l.failedReason ?? "—"}</span>
                      )}
                    </td>
                  </tr>
                ))}
